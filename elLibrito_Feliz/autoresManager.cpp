...
int autoresManager::seleccionarOcrearAutorPorNombre() {
    ...
    if (total > 0) {
        ...
        do {
                if(total == 1){
                    std::cout << "Seleccione la opción 1 para seleccionar el autor o 0 para crear nuevo autor: ";
                }
                else{
                    std::cout << "Seleccione una opción entr3 1 y " << total << " para seleccionar el autor o 0 para crear nuevo autor: ";
                }
                std::cin >> seleccion;
